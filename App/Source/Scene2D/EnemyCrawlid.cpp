 ...
 */
CEnemyCrawlid::CEnemyCrawlid(void)
	: bIsActive(false)
	, cMap2D(NULL)
	, cSettings(NULL)
	, cPlayer2D(NULL)
...
bool CEnemyCrawlid::Init(void)
{
	...
	// Load the EnemyCrawlid texture
	iTextureID = CImageLoader::GetInstance()->LoadTextureGetID("Image/crawlid.png", true);
	if (iTextureID == 0)
	{
		cout << "Unable to load Image/crawlid.png" << endl;
		return false;
	}
 ...
 */
void CEnemyCrawlid::Update(const double dElapsedTime)
{
	if (!bIsActive)
		return;
	...
	if (health <= 0)
	{
		...
		cInventoryManager->GetItem("Soul")->Add(20);
		cInventoryManager->GetItem("Geo")->Add(100);
		bIsActive = false;
	}
 ...
 */
void CEnemyCrawlid::PreRender(void)
{
	if (!bIsActive)
		return;
 ...
 */
void CEnemyCrawlid::Render(void)
{
	if (!bIsActive)
		return;
 ...
 */
void CEnemyCrawlid::PostRender(void)
{
	if (!bIsActive)
		return;
...
*/
void CEnemyCrawlid::Seti32vec2Index(const int iIndex_XAxis, const int iIndex_YAxis)
{
...
*/
void CEnemyCrawlid::Seti32vec2NumMicroSteps(const int iNumMicroSteps_XAxis, const int iNumMicroSteps_YAxis)
{
 ...
 */
void CEnemyCrawlid::SetPlayer2D(CPlayer2D* cPlayer2D)
{
 ...
 */
void CEnemyCrawlid::Constraint(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
		if (vec2Index.x < 0)
...
/**
 ...
 @param eDirection A DIRECTION enumerated data type which indicates the direction to check
 */
bool CEnemyCrawlid::CheckPosition(DIRECTION eDirection)
{
	if (eDirection == LEFT)
	{
...
// Check if the EnemyCrawlid is in mid-air
bool CEnemyCrawlid::IsMidAir(void)
{
...
// Update Jump or Fall
void CEnemyCrawlid::UpdateJumpFall(const double dElapsedTime)
{
 ...
 */
bool CEnemyCrawlid::InteractWithPlayer(void)
{
 ...
 */
void CEnemyCrawlid::UpdateDirection(void)
{
 ...
 */
void CEnemyCrawlid::FlipHorizontalDirection(void)
{
...
*/
void CEnemyCrawlid::UpdatePosition(void)
{
