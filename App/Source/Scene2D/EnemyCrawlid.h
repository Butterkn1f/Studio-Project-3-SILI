...
class CEnemyCrawlid : public CEntity2D
{
public:
	// Constructor
	CEnemyCrawlid(void);
...
protected:
	...
	// The vec2 which stores the indices of the EnemyCrawlid in the Map2D
	glm::vec2 i32vec2Index;

	// The vec2 variable which stores The number of microsteps from the tile indices for the EnemyCrawlid. 
	// A tile's width or height is in multiples of these microsteps
	glm::vec2 i32vec2NumMicroSteps;

	// The vec2 variable which stores the UV coordinates to render the EnemyCrawlid
	glm::vec2 vec2UVCoordinate;

	// The vec2 which stores the indices of the destination for EnemyCrawlid in the Map2D
	glm::vec2 i32vec2Destination;
	// The vec2 which stores the direction for EnemyCrawlid movement in the Map2D
	...
	// Constraint the EnemyCrawlid's position within a boundary
	...
	// Let EnemyCrawlid interact with the player
