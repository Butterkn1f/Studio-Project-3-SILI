...
class CEnemyFalseKnight : public CEntity2D
{
public:
	// Constructor
	CEnemyFalseKnight(void);

	// Destructor
	virtual ~CEnemyFalseKnight(void);
...
protected:
	...
	// The vec2 which stores the indices of the destination for EnemyFalseKnight in the Map2D
	glm::vec2 i32vec2Destination;
	// The vec2 which stores the direction for EnemyFalseKnight movement in the Map2D
