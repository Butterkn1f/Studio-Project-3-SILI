...
bool Application::Init(void)
{
	...
	cSettings->pWindow = glfwCreateWindow(	cSettings->iWindowWidth, cSettings->iWindowHeight,
											"Hollow Knight Knockoff", NULL, NULL);
	...
	CGameStateManager::GetInstance()->AddGameState("OptionsState", new COptionsState());
	...
	CGameStateManager::GetInstance()->AddGameState("JumpscareState", new JumpscareState());
...
void Application::Run(void)
{
	...
	while (!glfwWindowShouldClose(cSettings->pWindow))
	{
		...
		// cout << cFPSCounter->GetFrameRateString() << endl;
	}
}
